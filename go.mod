...
require (
	...
	k8s.io/kube-scheduler v0.21.10
...
require (
	...
	k8s.io/apiserver v0.21.10 // indirect
	k8s.io/cloud-provider v0.21.10 // indirect
	k8s.io/component-helpers v0.21.10 // indirect
	k8s.io/csi-translation-lib v0.21.10 // indirect
